module.exports = {
    ...
    token: "MTE2ODg1NTUxNDM1NzE5MDY1Ng.GbAoPZ.Ivr3pFeI6M5mZyMYF3XI-w36x6cp-rwTD-GEnU", //Bot Tokeniniz => Bot Oluşturduktan Sonra Intentsleri Açmayı Unutma!
    guildID: "1121869952190795836", //Kullanıcağın Sunucunun ID'si
    voiceChannelID: "1132409528659488879", // Ses Kanal ID'si
    presence: "astrexien", //Botun Durumu
    footer: "Beş & Luppux", //Embedların Footer Yazısı
    botOwners: ["1120998077529071646"], //Bot Sahibinin ID'si
    ...
    staffs: ["1132409502742876331"], // Yetkililerin Rol ID'leri ["55555","55555"] Şeklinde Girilir
